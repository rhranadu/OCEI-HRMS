	...
	<div class="container">
		<div class="table-responsive">
			...
			<table id="" class="table table-bordered">
				...
				<tr>
					<th colspan="4" style="text-align: center;">{{$results->first_name}} {{$results->last_name}} <br /> <span>{{$results->designation_name }}</span></th>
				</tr>
				<tr>
				...
				<tbody>
					@if(count($results['parpormance']) > 0)
						@php
							$serial = 0;
							$totalRating = 0;
							$item = 0;
						@endphp
						@foreach($results['parpormance'] as $key => $value)
							@php
								$item++;
