							...
							<div class="panel-wrapper collapse in">
								...
								<div class="panel-footer">
									...
									@elseif($value->status == 0)
										<a href="{{route('applicant.shortlist',$value->job_applicant_id)}}" onclick="return confirm('you are want to shortlist this applicant.are you sure?')"> <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Short Listed</button></a>
