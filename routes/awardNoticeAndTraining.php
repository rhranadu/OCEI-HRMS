...
Route::group(['middleware' => ['preventbackbutton','auth']], function(){
    ...
    Route::group(['prefix' => 'trainingInfo'], function () {
        ...
        Route::get('/{trainingInfo}/complete',['as'=>'trainingInfo.status.complete','uses'=>'AwardNoticeAndTraining\EmployeeTrainingController@statusComplete']);
    });
    ...
    Route::get('dateFilterTrainingReport',['as' => 'employeeTrainingReport.dateFilterTrainingReport', 'uses'=>'AwardNoticeAndTraining\TrainingReportController@dateFilterTrainingReport']);
