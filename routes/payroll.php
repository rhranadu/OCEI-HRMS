...
Route::group(['middleware' => ['preventbackbutton','auth']], function(){
    ...
    // present pay scale
    Route::group(['prefix' => 'presentPayScale'], function () {
        Route::get('/',['as' => 'presentPayScale.index', 'uses'=>'Payroll\PresentPayScaleController@index']);
        Route::get('/create',['as' => 'presentPayScale.create', 'uses'=>'Payroll\PresentPayScaleController@create']);
        Route::post('/store',['as' => 'presentPayScale.store', 'uses'=>'Payroll\PresentPayScaleController@store']);
        Route::get('/{presentPayScale}/edit',['as'=>'presentPayScale.edit','uses'=>'Payroll\PresentPayScaleController@edit']);
        Route::put('/{presentPayScale}',['as' => 'presentPayScale.update', 'uses'=>'Payroll\PresentPayScaleController@update']);
        Route::get('/{presentPayScale}/delete',['as'=>'presentPayScale.delete','uses'=>'Payroll\PresentPayScaleController@destroy']);
    });
